...
{
	public sealed class PipeClientChannel : IChannel, IChannelSender
	{
		// Channel information
		...
		/// </summary>
		public PipeClientChannel(string channelName)
		{
		...
		/// </summary>
		public PipeClientChannel(IDictionary properties, IClientChannelSinkProvider sinkProvider)
		{
		...
		{
			return new BinaryConnection(this, new TransportClient(channelUri, typeof(PipeTransport)));
		}
	}
}